...
inline constexpr std::array<std::pair<LayerType, size_t>, 34> kLayerTypeOrders{
...
inline constexpr std::array<size_t, 2> kDenseLayers{31, 33};

inline constexpr std::array<size_t, 14> kReluBnLayers{
    1, 3, 6, 8, 11, 13, 15, 18, 20, 22, 25, 27, 29, 32};
