...
struct VrsCache {
  ...
  constexpr static int64_t kGOffset = 0;
  ...
  static bool CheckVarComs(h256_t const& seed, Fr const& key,
    ...
    for (int64_t i = 0; i < num_var; ++i) {
      ...
      auto check_var_com = PcComputeCommitmentG(kGOffset, data, var_com_r);
  ...
  static void ComputeVarComs(h256_t const& seed, Fr const& key,
    ...
    for (int64_t i = 0; i < num_var; ++i) {
      ...
      var_com = PcComputeCommitmentG(kGOffset, data, var_com_r);
    }
  }
